...
# WMs & Needed Pkgs
sleep 5; sudo pacman -S --needed --noconfirm awesome qtile firefox nitrogen picom pcmanfm lxappearance rofi kitty volumeicon network-manager-applet python-pip htop emacs neovim polkit lxsession xdg-user-dirs python-psutil
...
# Other useful pkgs
sleep 5; sudo pacman -S --needed --noconfirm bleachbit gvfs ntfs-3g vi vim nano galculator brightnessctl font-manager viewnior yt-dlp xorg-xclipboard xclip feh acpid jedi-language-server curl wget go ripgrep fd nodejs
